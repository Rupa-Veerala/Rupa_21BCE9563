...
class Chess {
	...
	async assignPlayers() {
		...
		return new Promise((resolve) => {
			const player1 = new Player({ username: "Rupa", id: 1, role: "white" }); // player 1
			const player2 = new Player({ username: "Leela", id: 2, role: "black" }); // player 2
...
class Piece {
	...
	create() {
		...
		// apply
		pieceElement.src = `./Chess/photos/pieces/${this.info.alias}.png`;
...
class Player {
	...
	async getPieces() {
		...
		let path = `./Chess/javascript/json/${role}-pieces.json`; // just a path of json file
